"""Regression checks for the ion-ops-bundle-plane casebook."""
...
from casebook.harness import assert_expected, ion_ops_bundle_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_ops_bundle_plane_summary(), assert_expected())
